...
class UNetBaselineJointDifficulty(nn.Module):
    """Same U-Net as baseline + scalar difficulty head on e4 (before bottleneck) for Task 3 joint training."""
    ...
    def __init__(self, in_channels: int = 3, base: int = 32):
        ...
        self.diff_gap = nn.AdaptiveAvgPool2d(1)
        self.diff_head = nn.Linear(c4, 1)
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        diff_pred = self.diff_head(self.diff_gap(e4).flatten(1))
